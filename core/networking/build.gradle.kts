...
object NetworkingConfig {
	...
	const val PACKAGE_DESCRIPTION = "A Kotlin Multiplatform library to hold networking urls"
}
...
tasks.register("publishXCFrameworkToGitHub") {
	...
	doLast {
        ...
        // Do not edit manually - see core/networking/build.gradle.kts for the generation logic.
